...
class BeatDetection {
	...
	private function smoothing(bands:Array<FastComplexArray>): Array<FastComplexArray> {
	...
	private function differentiate(bands:Array<FastComplexArray>): Array<FastComplexArray> {
		for (band in bands) {
			band.diff_rect();
		}
	}
